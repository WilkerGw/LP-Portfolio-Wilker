...
const projects: ProjectItem[] = [
    {
        id: 1,
        title: 'Mind ERP',
        description: 'Sistema completo de gestão para óticas com Dashboard e Chatbot.',
              ...
              ${activeId === project.id ? 'flex-[3]' : 'flex-1'}`}
                    >
                        ...
                        <div className="relative h-full flex flex-col justify-end p-6 text-white">
                            <h3 className={`text-2xl font-bold font-heading transition-all duration-500 ${activeId === project.id ? 'mb-4 translate-y-0 text-white' : 'mb-10 -rotate-90 origin-left whitespace-nowrap text-gray-300'}`}>
                                {project.title}
                            </h3>

                            <div className={`transition-all duration-500 delay-100 ${activeId === project.id ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
